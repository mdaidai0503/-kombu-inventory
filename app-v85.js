...
(function(){
  const css=document.createElement('style');
  css.textContent=`
    .v85-stock-split{display:flex;width:100%;overflow:hidden;border:1px solid #e1e7ee;border-radius:10px;background:#fff;position:relative}
    .v85-fixed-pane{flex:0 0 172px;width:172px;overflow:hidden;background:#fff;position:relative;z-index:5;border-right:2px solid #cfd8e3}
    .v85-scroll-pane{flex:1 1 auto;min-width:0;overflow:auto;-webkit-overflow-scrolling:touch;background:#fff;position:relative;z-index:1}
  ...
  function splitTable(table){
    ...
    if(hadMax)split.style.height=visibleH+'px';
  ...
  ['productLanding','productChoicePage'].forEach(name=>{
    const fn=window[name];if(typeof fn!=='function')return;
    window[name]=function(){const r=fn.apply(this,arguments);const pill=app.querySelector('.pill');if(pill)pill.textContent='v85';return r};
  });
