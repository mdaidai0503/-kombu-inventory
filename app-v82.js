...
(function(){
  ...
  style.textContent=`
    .stock-report.v82-inventory-table{width:auto!important;min-width:0!important;table-layout:auto!important}
    .stock-report.v82-inventory-table th,.stock-report.v82-inventory-table td{padding:4px 5px!important;white-space:nowrap}
    .stock-report.v82-inventory-table tr>:not(.v82-fixed1):not(.v82-fixed2){min-width:54px;max-width:68px}
    .stock-report.v82-inventory-table .v82-fixed1{position:sticky!important;left:0!important;z-index:5!important;min-width:108px!important;width:108px!important;max-width:108px!important;background:#fff!important;text-align:left!important}
    .stock-report.v82-inventory-table .v82-fixed2{position:sticky!important;left:108px!important;z-index:5!important;min-width:64px!important;width:64px!important;max-width:64px!important;background:#fff!important;text-align:center!important;box-shadow:2px 0 0 #cfd8e3}
    ...
    .tablewrap.v82-scroll{overflow:auto!important;-webkit-overflow-scrolling:touch}
  `;
  ...
  if(typeof oldLanding==='function')window.productLanding=function(){const r=oldLanding.apply(this,arguments);const pill=app.querySelector('.pill');if(pill)pill.textContent='v82';return r};
  const oldChoice=window.productChoicePage;
  if(typeof oldChoice==='function')window.productChoicePage=function(){const r=oldChoice.apply(this,arguments);const pill=app.querySelector('.pill');if(pill)pill.textContent='v82';return r};
