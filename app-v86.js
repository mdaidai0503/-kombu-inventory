...
(function(){
  ...
  css.textContent=`
    ...
    #app,main,.card{max-width:100%!important;min-width:0!important;box-sizing:border-box!important}
    .v85-stock-split{display:block!important;width:100%!important;max-width:100%!important;min-width:0!important;overflow:hidden!important;border:1px solid #e1e7ee;border-radius:10px;background:#fff;position:relative!important;box-sizing:border-box!important;contain:layout paint!important}
    .v85-fixed-pane{position:absolute!important;left:0!important;top:0!important;bottom:0!important;width:172px!important;min-width:172px!important;max-width:172px!important;overflow:hidden!important;background:#fff;z-index:20!important;border-right:2px solid #cfd8e3;box-sizing:border-box!important;transform:none!important}
    .v85-scroll-pane{position:absolute!important;left:172px!important;right:0!important;top:0!important;bottom:0!important;width:auto!important;min-width:0!important;max-width:none!important;overflow-x:auto!important;overflow-y:auto!important;-webkit-overflow-scrolling:touch!important;background:#fff;z-index:1!important;box-sizing:border-box!important;overscroll-behavior-x:contain!important;touch-action:pan-x pan-y!important}
  ...
  ['productLanding','productChoicePage'].forEach(name=>{
    const fn=window[name];if(typeof fn!=='function')return;
    window[name]=function(){const r=fn.apply(this,arguments);const pill=app.querySelector('.pill');if(pill)pill.textContent='v86';return r};
  });
  requestAnimationFrame(run);
})();
/* ===== /v85 ===== */

/* v86: absolute split panes; left pane is outside horizontal scroll area */
