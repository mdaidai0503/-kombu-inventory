...
function _stockCanvasPage(year){
 ...
 const shHead=!!window.__v62ShipmentHeaderLarge; text('組合名',tableX+coopW/2,tableY+(h1+h2)/2,shHead?18:14,'center',true);text('区分',xCoop+seasonW/2,tableY+(h1+h2)/2,shHead?18:14,'center',true);text('計',xData+dataW+totalW/2,tableY+(h1+h2)/2,shHead?18:14,'center',true);
...
function v55CanvasKushiro(s,y){
  ...
  try{
    ...
    state.shipments=[];
    window.__v58ShipmentCoopLower=true;window.__v62ShipmentHeaderLarge=true;try{return v55RetitleStockCanvas(_stockCanvasPage(y),'釧路産昆布　出 荷 依 頼 書',y,s,112,44);}finally{window.__v58ShipmentCoopLower=false;window.__v62ShipmentHeaderLarge=false;}
...
function v55CanvasHidaka(s,y){
  ...
  try{
    ...
    hState.shipments=[];
    window.__v59HidakaSectionCentered=true;window.__v62ShipmentHeaderLarge=true;try{return v55RetitleStockCanvas(hStockCanvas(y),'日高昆布　出 荷 依 頼 書',y,s,80,35);}finally{window.__v59HidakaSectionCentered=false;window.__v62ShipmentHeaderLarge=false;}
...
function v55CanvasNemuro(s,y){
  ...
  try{
    ...
    nState.shipments=[];
    window.__v58ShipmentCoopLower=true;window.__v62ShipmentHeaderLarge=true;try{return v55RetitleStockCanvas(nReportCanvas(y,null),'根室産昆布　出 荷 依 頼 書',y,s,70,34);}finally{window.__v58ShipmentCoopLower=false;window.__v62ShipmentHeaderLarge=false;}
...
function v55CanvasSanmae(s,y){
  ...
  try{
    ...
    smState.shipments=[];
    window.__v58ShipmentCoopLower=true;window.__v62ShipmentHeaderLarge=true;try{return v55RetitleStockCanvas(smReportCanvas(y,null),'釧路産棹前昆布　出 荷 依 頼 書',y,s,70,34);}finally{window.__v58ShipmentCoopLower=false;window.__v62ShipmentHeaderLarge=false;}
