  ...
  app.innerHTML=`
    <style>
      ...
      @media(max-width:430px){
        ...
        #v75ShipTable th:nth-child(1),#v75ShipTable td:nth-child(1){width:76px}
        ...
        #v75ShipTable th:nth-child(5),#v75ShipTable td:nth-child(5){width:46px}
...
/* ===== v76: 出荷指示一覧 FAX済/伝票済チェック + 6字幅スクロール + 開く ===== */
...
function v76ShipmentMenu(){
  ...
  const body=rows.map(r=>{const ck=checks[v76ShipCheckId(r.product,r.s.id)]||{};return `<tr data-gprod="${r.product}" data-gid="${esc(r.s.id||'')}">
    ...
    <td><div class="v76-cellscroll v76-date" title="${esc(r.s.shipDate||'')}">${esc(r.s.shipDate||'')}</div></td>
    <td class="v76-kombu"><b>${esc(v74ShipmentShortName(r.product))}</b></td>
    <td><div class="v76-cellscroll" title="${esc(r.src||'')}">${esc(r.src||'')}</div></td>
    <td><div class="v76-cellscroll" title="${esc(r.dst||'')}">${esc(r.dst||'')}</div></td>
    <td class="v76-qty">${fmt(r.qty)}</td>
  ...
  app.innerHTML=`
    <style>
      #v76ShipTable{min-width:665px;width:100%;table-layout:fixed;font-size:10.5px}
      #v76ShipTable th,#v76ShipTable td{padding:5px 3px;line-height:1.2;vertical-align:middle;text-align:center}
      #v76ShipTable th:nth-child(1),#v76ShipTable td:nth-child(1),#v76ShipTable th:nth-child(2),#v76ShipTable td:nth-child(2){width:43px}
      #v76ShipTable th:nth-child(3),#v76ShipTable td:nth-child(3){width:72px}
      #v76ShipTable th:nth-child(4),#v76ShipTable td:nth-child(4){width:43px}
      #v76ShipTable th:nth-child(5),#v76ShipTable td:nth-child(5),#v76ShipTable th:nth-child(6),#v76ShipTable td:nth-child(6){width:76px}
      #v76ShipTable th:nth-child(7),#v76ShipTable td:nth-child(7){width:46px}
      #v76ShipTable th:nth-child(8),#v76ShipTable td:nth-child(8){width:58px}
      #v76ShipTable th:nth-child(9),#v76ShipTable td:nth-child(9){width:48px}
      #v76ShipTable .v76-cellscroll{display:block;width:6em;max-width:100%;overflow-x:auto;overflow-y:hidden;white-space:nowrap;text-align:left;-webkit-overflow-scrolling:touch;scrollbar-width:none}
      #v76ShipTable .v76-cellscroll::-webkit-scrollbar{display:none}
      #v76ShipTable .v76-date{font-variant-numeric:tabular-nums}
      #v76ShipTable .v76-check input{width:20px;height:20px;margin:0;accent-color:#173760}
      #v76ShipTable .v76-qty{white-space:nowrap;font-variant-numeric:tabular-nums;text-align:right}
      #v76ShipTable .v76-status{white-space:nowrap}
      #v76ShipTable .v76-open .mini{padding:5px 7px;font-size:10px;white-space:nowrap}
      @media(max-width:430px){
        #v76ShipTable{min-width:620px;font-size:10px}
        #v76ShipTable th,#v76ShipTable td{padding:4px 2px}
        #v76ShipTable th:nth-child(1),#v76ShipTable td:nth-child(1),#v76ShipTable th:nth-child(2),#v76ShipTable td:nth-child(2){width:40px}
        #v76ShipTable th:nth-child(3),#v76ShipTable td:nth-child(3){width:68px}
        #v76ShipTable th:nth-child(4),#v76ShipTable td:nth-child(4){width:40px}
        #v76ShipTable th:nth-child(5),#v76ShipTable td:nth-child(5),#v76ShipTable th:nth-child(6),#v76ShipTable td:nth-child(6){width:70px}
        #v76ShipTable th:nth-child(7),#v76ShipTable td:nth-child(7){width:42px}
        #v76ShipTable th:nth-child(8),#v76ShipTable td:nth-child(8){width:54px}
        #v76ShipTable th:nth-child(9),#v76ShipTable td:nth-child(9){width:46px}
      }
    </style>
    <section class="card" style="margin-top:14px;padding:14px">
      <div class="row" style="align-items:center;margin-bottom:10px"><h2 style="margin:0;font-size:20px">出荷指示</h2><span class="pill">v76</span></div>
      <div style="display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px">
...
productChoicePage=function(mode){if(mode==='shipment')return v76ShipmentMenu();const r=_v76ProductChoiceBase(mode);const pill=app.querySelector('.pill');if(pill)pill.textContent='v76';return r};
const _v76LandingBase=productLanding;
productLanding=function(){const r=_v76LandingBase();const pill=app.querySelector('.pill');if(pill)pill.textContent='v76';return r};
productLanding();
