...
function v55CanvasHidaka(s,y){
  ...
  try{
    ...
    hState.shipments=[];
    window.__v59HidakaSectionCentered=true;try{return v55RetitleStockCanvas(hStockCanvas(y),'日 高 昆 布　出 荷 指 示 書',y,s,74);}finally{window.__v59HidakaSectionCentered=false;}
