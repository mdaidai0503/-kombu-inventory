...
function v76ShipmentMenu(){
  ...
  app.innerHTML=`
    <style>
      ...
      #v76ShipTable th:nth-child(3),#v76ShipTable td:nth-child(3){width:50px}
      ...
      #v76ShipTable .v76-cellscroll{display:block;width:4em;max-width:100%;overflow-x:auto;overflow-y:hidden;white-space:nowrap;text-align:left;-webkit-overflow-scrolling:touch;scrollbar-width:none}
      ...
      #v76ShipTable .v76-qty{display:block;width:2em;max-width:100%;overflow-x:auto;overflow-y:hidden;white-space:nowrap;font-variant-numeric:tabular-nums;text-align:right;scrollbar-width:none}#v76ShipTable .v76-qty::-webkit-scrollbar{display:none}
      ...
      @media(max-width:430px){
        ...
        #v76ShipTable th:nth-child(3),#v76ShipTable td:nth-child(3){width:46px}
        #v76ShipTable th:nth-child(4),#v76ShipTable td:nth-child(4){width:36px}
        #v76ShipTable th:nth-child(5),#v76ShipTable td:nth-child(5),#v76ShipTable th:nth-child(6),#v76ShipTable td:nth-child(6){width:48px}
        ...
        #v76ShipTable th:nth-child(9),#v76ShipTable td:nth-child(9){width:40px}
        #v76ShipTable .v76-check input{width:13px;height:13px}
      }
    </style>
    <section class="card" style="margin-top:14px;padding:14px">
      <div class="row" style="align-items:center;margin-bottom:10px"><h2 style="margin:0;font-size:20px">出荷指示</h2><span class="pill">v77</span></div>
      <div style="display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px">
